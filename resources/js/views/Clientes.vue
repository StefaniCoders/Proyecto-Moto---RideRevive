<template>
    <div>
        ...
        <div class="card-body">
          ...
          <div class="col-md-12 p-20 m-2 border">
            <table id="example" class="display" style="width: 100%">
              ...
              <tbody>
                <tr v-for="item in usuarios" :key="item.IdCliente">
                  <td>{{ item.Nombres }}</td>
                  ...
                  <td>{{ item.telefono }}</td>
                  <td>
                <button class="btn btn-warning"  @click="openModal(item.IdCliente)">Editar</button>
                <button class="btn btn-danger"  @click="eliminar(item.IdCliente)">Eliminar</button>
              </td>
                </tr>
              </tbody>
            </table>
      ...
      <b-modal ref="modal" title="Nuevo Cliente" v-model="show" hide-footer>
  ...
  export default {
    ...
    methods: {   
      ...
      getUsuarios() {   
        ...
        let url = "./clientes-records?"+params;
        console.log(url);
        axios({
          method: "GET",
          url: url,
