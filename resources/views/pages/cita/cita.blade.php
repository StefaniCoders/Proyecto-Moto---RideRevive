...
<div class="card">
    <div class="card-body">
        ...
        <div class="col-md-12 p-3 form-inline">
            ...
            <a href="#modal-create-cita" rel="modal:open" onclick="showModalCreateCita()"  class="btn btn-primary ml-2">Nueva Cita</a>
        ...
        <div class="modal fade" id="editCita" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div id="modal-create-cita"  class="modal fade"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                              <div class="modal-content">
                                  <div class="modal-header">
...
function showModalCreateCita(){
    $("#modal-create-cita").modal('show');   
}
